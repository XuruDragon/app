...
Devise.setup do |config|
  config.warden do |manager|
    ...
    manager.default_strategies(scope: :api_user).unshift :two_factor_authenticatable
    manager.default_strategies(scope: :api_user).unshift :two_factor_backupable
  ...
  config.strip_whitespace_keys = %i[login email username]
  ...
  # config.pepper = '9bffd3b8bd3c9d4929a7b61b7d4ccebc49aeca8ed647233af4aac27772ddc9a2be46dc26ab7bd1c011be64c853d16c5ba73fbc78f449b14b591fea98423dbf55'
  ...
  config.rememberable_options = { secure: true, key: 'remember_me_token' }
